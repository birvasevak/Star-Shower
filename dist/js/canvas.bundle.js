...
Star.prototype.update = function () {
  this.draw(); // Ball hits bottom of the screen
  ...
  } // when ball hits side of the screen
...
function init() {
  stars = [];
  ministars = [];
  backgroungStars = []; // for (let i = 0; i < 1; i++) {
  ...
  for (var i = 0; i < 150; i++) {
    ...
    backgroungStars.push(new Star(x, y, radius, "white"));
  }
} // Animation Loop
...
function animate() {
  ...
  backgroungStars.forEach(function (backgroungStar) {
    backgroungStar.draw();
  });
